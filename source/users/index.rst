...
.. grid::  4
    ...
    .. grid-item-card:: Settings
        :img-top: ../_external/_images/ico/128x128/settings.png
    ...
    .. grid-item-card:: Folio
        :img-top: ../_external/_images/ico/256x256/folio.png
        :img-alt: Image showing QelectroTech app icon
    
    .. grid-item-card:: Element
        :img-top: ../_external/_images/ico/128x128/element.png
        :img-alt: Image showing QelectroTech app icon
    ...
    .. grid-item-card:: Schema
        :img-top: ../_external/_images/ico/128x128/diagram.png
        :img-alt: Image showing QelectroTech app icon

    .. grid-item-card:: Drawing
        :img-top: ../_external/_images/ico/256x256/drawing.png
        :img-alt: Image showing QelectroTech app icon
    ...
    .. grid-item-card:: Export & Print
        :img-top: ../_external/_images/ico/128x128/printer.png
        :img-alt: Image showing QelectroTech app icon
    
    .. grid-item-card:: Annex
        :img-top: ../_external/_images/ico/256x256/qelectrotech.png
        :img-alt: Image showing QelectroTech app icon
